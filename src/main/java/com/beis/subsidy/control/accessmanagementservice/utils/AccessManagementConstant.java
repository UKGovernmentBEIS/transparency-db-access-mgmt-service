...
public class AccessManagementConstant {
    ...
    public static String GA_PUBLISHED_STATUS="Published";

    public static String SM_AWAITING_APPROVAL ="Awaiting approval";
    public static String SM_DRAFT="Draft";
    public static String SM_PUBLISHED_STATUS="Published";
    public static String SM_DELETED="Deleted";

    public static String AWARD_AWAITING_APPROVAL ="Awaiting approval";
    public static String AWARD_DRAFT="Draft";
    public static String AWARD_PUBLISHED_STATUS="Published";
    public static String AWARD_DELETED="Deleted";
